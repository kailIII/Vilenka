...
class archivos extends CI_Controller {
	...
	private function upload_file($file_id) {
        ...
        $config['allowed_types'] = 'png|psd|vmp|jpg|jpeg|gif|ico|tiff|drw|crd|cdr|swf|divx|mpg|ttf|htm|wav|wma|ogg|xls|doc|ppt|docx|xlsx|pptx|mov|mp3|mp4|avi|pdf|txt|html|ai|tar|7z|mpeg|rar|zip|';
        $this->load->library('upload', $config);
